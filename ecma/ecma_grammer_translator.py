...
if __name__=='__main__':
	...
	in_file = 'res/ecma_2018_9_0/grammer_12_Expressions.txt'
	out_file = 'js/Expressions_rules.py'
	Translator().loadfile(in_file, out_file)

	in_file = 'res/ecma_2018_9_0/grammer_13_Statements_and_Declarations.txt'
	out_file = 'js/Statements_and_Declarations_rules.py'
	Translator().loadfile(in_file, out_file)

	in_file = 'res/ecma_2018_9_0/grammer_14_Functions_and_Classes.txt'
	out_file = 'js/Functions_and_Classes_rules.py'
	Translator().loadfile(in_file, out_file)
	#t = Translator()
